...
- **Registration** - `NookConfiguration`, `NookTopBarConfiguration`,
  `NookBuiltInSettingsConfiguration`, `NookBuiltInSettingsItem`, and
  `NookSettingsSection`. The
  host-app seam: home/compact content, theme, lifecycle hooks, chrome flags, the
  shape/animation/width knobs, built-in Settings visibility, injected Settings
  sections, and complete Settings replacement. See
